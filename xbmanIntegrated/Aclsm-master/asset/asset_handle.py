...
def fetch_asset_list():
    ...
    asset_list = models.RoomAsset.objects.all()
    data_list = []
    for obj in asset_list:
        if hasattr(obj,'name') or hasattr(obj,'networkdevice'):
            if obj.asset_type == 'server':
                data = {
                    ...
                    'cabinet': obj.Cabinet,
                    'slot': obj.Slot,
                    'serviceModule' : obj.ServiceModule,
                    'system' : obj.System,
                    'raidInfo': obj.RaidInfo,
                    'idc': get_idc(obj.idc_id),
                    'torCabinet': obj.TorCabinet,
                }
