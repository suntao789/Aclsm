...
class RoomAssetAdmin(admin.ModelAdmin):
    list_display = ('id','asset_type','Sn','Brand','MaintenanceSn','ilo','idc','Cabinet','ServerConfig','status')
    inlines = [PeopleInline,]
    search_fields = ['sn',]
    list_filter = ['idc','Cabinet','MaintenanceSn','ServerConfig','asset_type']
...
admin.site.register(models.RoomAsset)
